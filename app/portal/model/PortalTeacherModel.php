...
class PortalTeacherModel extends Model
{
...
//        }
    ...
    public function adminAddTeacher($data)
    {
...
//        $keywords = explode(',', $data['post_keywords']);
        ...
        $id = Db::name('portal_teacher')->insertGetId($data);
    ...
    public function adminEditTeacher($data)
    {
...
//        }
        ...
        $tp = $this->allowField(true)->isUpdate(true)->data($data, true)->save();
