...
class PostService
{
     ...
     * @throws \think\exception\DbException
     */
    public function adminTeacheList($filter)
    {
        return $this->adminPostTeacheList($filter);
    }
     ...
     * @throws \think\exception\DbException
     */
    public function adminPostTeacheList($filter, $isPage = false)
    {
...
//                }
                ...
                $teacher_name = empty($filter['teacher_name']) ? '' : $filter['teacher_name'];
                if (!empty($teacher_name)) {
                    $teacher_name = trim($teacher_name);
                    $query->where('teacher_name','like', "%$teacher_name%");
                }

                $iphone = empty($filter['iphone']) ? '' : $filter['iphone'];
                if (!empty($iphone)) {
                    $iphone = trim($iphone);
                    $query->where('iphone',  'like', "%$iphone%");
                }
                ...
                $website = empty($filter['website']) ? '' : $filter['website'];
                if (!empty($website)) {
